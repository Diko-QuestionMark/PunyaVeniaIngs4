...
<div style="padding-top:70px;">
  <!-- Page Header -->
  <div style="background:linear-gradient(135deg,#0F172A,#1E293B);padding:60px 5% 50px;text-align:center;">
  ...
  <div style="max-width:1200px;margin:0 auto;padding:40px 5% 80px;">
    ...
    <div style="margin-bottom:48px;">
      <div style="display:flex;align-items:center;gap:10px;margin-bottom:20px;padding-bottom:14px;border-bottom:2px solid #F1F5F9;">
