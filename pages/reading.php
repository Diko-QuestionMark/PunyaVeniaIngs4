...
$videos = $db->query("SELECT * FROM learning_videos WHERE section='reading' AND is_published=1 ORDER BY sort_order")->fetchAll();
?>
<!DOCTYPE html>
<html lang="id">
<head>
...
<div style="max-width:1200px;margin:0 auto;padding:50px 5% 80px;">
  ...
  <div data-aos="fade-up" style="margin-bottom:48px;">
    <h2 style="font-size:1.2rem;margin-bottom:20px;">📺 Video Pembelajaran Reading</h2>
